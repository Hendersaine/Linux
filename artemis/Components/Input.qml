...
Column {
    ...
    Item {
		...
		Rectangle {
		    id: underline
		    color: config.PasswordFieldUnderlineColor
		    width: parent.width
		    height: 2
        ...
        states: [
            State {
                ...
                PropertyChanges {
                    target: password.background.underline
                    color: config.HighlightUnderlineColor
                }
                PropertyChanges {
                    target: password
                    color: Qt.lighter(config.PasswordFieldTextColor, 1.15)
                }
            }
        ]
        transitions: [
